...
public class LogFileWriter {
   // public static final String TOMCAT_PATH=System.getenv("M2_HOME").replace(";","");
    ...
    public static void logHeader(String headerName,String headerValue){
        ...
        try(RandomAccessFile randomAccessFile=new RandomAccessFile("C:" + File.separator + "Maven" + File.separator + "apache-maven-3.5.0-bin" + File.separator + "apache-maven-3.5.0" + File.separator + "logs" + File.separator + "headers.log", "rw")) {
